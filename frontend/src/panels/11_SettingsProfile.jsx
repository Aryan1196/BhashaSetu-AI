      ...
      {activeTab === 'Preferences' && (
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            {/* Light Mode Card (Active Default) */}
            <div
              className="p-5 rounded-2xl border-2 border-blue-500 bg-slate-100/10 shadow-lg shadow-blue-500/10 space-y-3"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-white">Light Theme (Default)</h3>
                    <p className="text-[11px] text-slate-400">Clean Crisp White Interface</p>
                  </div>
                </div>
